...
const renderItem = function(poducts) {
    ...
    poducts.forEach((product)=>{
        productContainer.innerHTML += `
         <div class="product">
            <h3>${product.title}</h3>
            <p>${product.price}</p>
            <button data-id="${product.id}">\u{43A}\u{443}\u{43F}\u{438}\u{442}\u{438}</button>
        </div>
        `;
    });
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequire8107", {})

//# sourceMappingURL=MiniShop.31b563d9.js.map
